...
import './InstructionAnalytics.css'
...
const InstructionAnalytics = () => {
  ...
  return (
    <div className="container">
      ...
      <button>x</button>
            <motion.div className='instruction_map' viewport={{ once: true, amount: 0.7 }} variants={fadeIn} initial='hidden' whileInView='visible'><ExploreData2/></motion.div>
            <motion.div className='description' viewport={{ once: true, amount: 0.3 }} variants={fadeIn} initial='hidden' whileInView='visible'>
